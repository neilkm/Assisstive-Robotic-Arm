...
|-------------|-----------|-------------|
| `esp32dev` | _(none)_ | Random button telemetry — production |
| `esp32dev_bluetooth_echo_test` | `-DESP32_BT_ECHO_TEST` | Bluetooth UART echo test |

## Build and flash

```bash
Software/arm.sh build esp32 normal
Software/arm.sh flash esp32 normal
Software/arm.sh flash esp32 echo
```
...
scripts/flash_random_button_test.py  Direct flash helper
```
